...
<body>
    ...
    <div class="container-fluid bg-primary p-5 bg-hero mb-5">
        <div class="row py-5">
            <div class="col-12 text-center">
                ...
                <a href="editStorage.php" class="btn btn-light py-md-3 px-md-5">Manipulate Storage</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
    ...
    while($row=mysqli_fetch_array($query)){
        $id=$row['inventoryID'];//PLEASE CHANGE ACCORDING TO YOUR DATABASE AUTO-INCREAMENT ID
        $sql = "UPDATE inventory SET inventoryID=$number WHERE inventoryID=$id";
    ...
    $sql = "ALTER TABLE inventory AUTO_INCREMENT =1"; //CHANGE TABLE NAME
    if($conn->query($sql) == TRUE){
