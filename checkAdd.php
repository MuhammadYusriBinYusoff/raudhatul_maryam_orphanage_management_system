...
<body>
    ...
    <div class="container-fluid bg-primary p-5 bg-hero mb-5">
        <div class="row py-5">
            <div class="col-12 text-center">
                <h1 class="display-2 text-uppercase text-white mb-md-4">Register Item Storage</h1>
                <a href="index.php" class="btn btn-primary py-md-3 px-md-5 me-3">Home</a>
                <a href="addItemStorage.php" class="btn btn-light py-md-3 px-md-5">Add Item</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
    ...
    <!-- Team Start -->
	 ...
	 $sql = "INSERT INTO inventory(itemNames, quantity, unit, category) VALUES ('$itemName','$itemQuantity', '$itemUnit', '$itemCategory')" ;
	 ...
	 echo "<p><a href='addItemStorage.php'>Click here to go to request item page</a></p>";
