...
<body>
    ...
    <div class="container-fluid bg-primary p-5 bg-hero mb-5">
        <div class="row py-5">
            <div class="col-12 text-center">
                ...
                <a href="manageRequest.php" class="btn btn-light py-md-3 px-md-5">Manipulate Item</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
    ...
    <!-- Team Start -->
        ...
        $sql="SELECT * FROM requestitem WHERE itemId='$ID'";
        ...
        <div class = 'request-header'>
            <div class = 'view-info'> 
            <form method ="post" action ="updateItemVerification.php" name="viewForm">
                <table width="600" border="1" cellspacing="0" cellpadding="3">
             
                <!-- Print table heading -->
                <tr>
                <td align="center"><strong>Id</strong></td>
                <td ><input name="itemId" type="number" id="itemId" value="<?php echo $rows['itemId']; ?>" required></td>
                </tr>

                <tr>
                <td align="center"><strong>Item Name</strong></td>
                <td ><input name="itemName" type="text" id="itemName" size="30" value="<?php echo $rows['itemName']; ?>" required></td>
                </tr>

                <tr>
                <td align="center"><strong>Quantity</strong></td>
                <td><input name="itemQuantity" type="number" id="itemQuantity" size="15" value="<?php echo $rows['itemQuantity']; ?>" required></td>
                </tr>

                <tr>
                <td align="center"><strong>Category</strong></td>
                <td><input name="category" type="text" id="category"  size="15" value="<?php echo $rows['category']; ?>" required></td>
                </tr>

                <tr>
                <td align="center"><strong>Dates</strong></td>
                <td><input name="dates" type="date" id="dates"  size="15" value="<?php echo $rows['dates']; ?>" required></td>
                </tr>
