                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    ...
                                    <a href="viewHistory.php" class="dropdown-item"><i class="fa fa-history text-primary me-2"></i>View History</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
    ...
    <div class="container-fluid bg-primary p-5 bg-hero mb-5">
        <div class="row py-5">
            <div class="col-12 text-center">
                <h1 class="display-2 text-uppercase text-white mb-md-4">Request Donations</h1>
                <a href="index.php" class="btn btn-primary py-md-3 px-md-5 me-3">Home</a>
                <a href="requestDonation.html" class="btn btn-light py-md-3 px-md-5">Request Donations</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
...
*/
	 ...
	 $sql = "INSERT INTO requestItem(itemName, itemQuantity, unit, category, dates) VALUES ('$itemName','$itemQuantity','$itemUnit','$itemCategory','$date')" ;

     /*
require("config.php");
$sql = "INSERT INTO requestITEM(itemName, itemQuanitty) VALUES ('$data','$name')";

if(myaqli_query($conn, $sql)){
    echo "<h3>success</h3>";
}else{
    echo "<h1>echo/h1>"
}
*/
	 ...
	 if (mysqli_query($conn, $sql)) {
		echo "<h3>Item inserted successfully</h3>";
		} else {
			echo "Error: " . $sql . "<br>" . mysqli_error($conn);
			}
	  mysqli_close($conn);
	
	 echo "<p><a href='requestDonation.html'>Click here to go to request item page</a></p>";
