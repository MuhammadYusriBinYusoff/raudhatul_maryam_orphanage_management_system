...
<body>
    ...
    <!-- Team Start -->
        ...
        <?php
         ...
         $sql = "UPDATE inventory SET itemNames = '$itemName', quantity = '$itemQuantity', unit = '$itemUnit', category = '$category' WHERE inventoryID = '$ID'" ;
         if (mysqli_query($conn, $sql)) {
			echo "<h3>Record has been saved</h3>";
			} else {
