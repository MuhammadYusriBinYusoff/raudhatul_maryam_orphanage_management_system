                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0 px-lg-5">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="team.html" class="nav-item nav-link">Donors</a>
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    ...
                                    <a href="viewDonation.php" class="dropdown-item">View Request</a>
                                    <a href="itemDb.php" class="dropdown-item">Manipulate Item Request</a>
                                </div>
                            </div>
                            </div>
    ...
    <div class="container-fluid bg-primary p-5 bg-hero mb-5">
        <div class="row py-5">
            <div class="col-12 text-center">
                <h1 class="display-2 text-uppercase text-white mb-md-4">Inventory</h1>
                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3">Home</a>
                <a href="team.html" class="btn btn-light py-md-3 px-md-5">Inventory</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
        ...
        <div class = 'request-header'>
            ...
            <form method ="post" action ="" name="viewForm">
                ...
                <tr>
                    ...
                    <td align="center"> <a href="updateItem.php?id=<?php echo $rows['itemId']; //guna get?>">update</a> </td>
                    <td align="center"> <a href="deleteItem.php?id=<?php echo $rows['itemId']; ?>">delete</a> </td>
                </tr>
