...
<head>
    <meta charset="utf-8">
    <title>Gallery of Donations</title>
        ...
        <div class="row gx-5">
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <p class="mb-0">11, Jalan Pulai 54, Taman Pulai Utama, 81300 Skudai, Johor</p>
                        </div>
                        <div class="d-flex mb-2">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-5">
                    ...
                    <h6 class="text-uppercase text-white">Subscribe</h6>
        ...
        <div class="row gx-5">
            <div class="col-lg-8">
                <div class="py-lg-4 text-center">
                    <p class="text-secondary mb-0">&copy; <a class="text-light fw-bold" href="#">EDEN Team</a>. All Rights Reserved.</p>
                </div>
            </div>
            <div class="col-lg-4">
