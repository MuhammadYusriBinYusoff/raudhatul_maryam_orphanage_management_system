...
<head>
    ...
    <!-- Template Sendiri -->
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>css/reqItems.css">
...
<body>
    ...
    <div class="container-fluid bg-primary p-5 bg-hero mb-5">
        <div class="row py-5">
            <div class="col-12 text-center">
                ...
                <a href="viewDonation.php" class="btn btn-light py-md-3 px-md-5"><i class="fa fa-eye text-primary me-2"></i>User request</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
    ...
    <div class="container-fluid p-5">
        ...
        <?php
        require ("../../config.php"); 
        $sql = "SELECT * FROM requestitem";
             $result = mysqli_query($conn, $sql); //means $sql run dalm php myadmin
        ...
        <div class = 'request-header'>
            <div class = 'view-info'> 
            <form method ="post" action ="<?php echo BASE_URL; ?>index.php" name="viewForm">
                ...
                <?php
                    ...
                    while($rows = mysqli_fetch_assoc($result)) { //nak fetch or retrieve data intil complete from the row kite je...not other people row //mysqli tu adelah coding untuk run on php myadmin
                ?>
    
                <tr>
                    <td align="center"><?php echo $rows['itemId']; ?></td>
