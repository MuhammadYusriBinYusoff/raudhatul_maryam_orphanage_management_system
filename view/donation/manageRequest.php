    ...
    <div class="container-fluid bg-primary p-5 bg-hero mb-5">
        <div class="row py-5">
            <div class="col-12 text-center">
                ...
                <a href="manageRequest.php" class="btn btn-light py-md-3 px-md-5"><i class="fa fa-pen-square text-primary me-2"></i>Manipulate Item</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
        ...
        <div class = 'request-header'>
            ...
            <form method ="post" action ="<?php echo BASE_URL; ?>index.php" name="viewForm">
                ...
                <tr>
                    ...
                    <td align="center"> <a href="updateItem.php?id=<?php echo $rows['itemId']; //guna get?>"><i class="fa fa-pen text-primary me-2"></i></a> </td>
                    <td align="center"> <a href="deleteItem.php?id=<?php echo $rows['itemId']; ?>"><i class="fa fa-trash text-primary me-2"></i></a> </td>
                </tr>
